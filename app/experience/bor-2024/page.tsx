...
export default function BOR2024ExperiencePage() {
  return (
      ...
      <section className="mb-12">
        ...
        <div className="glass-panel rounded-2xl p-5 sm:p-6">
          <p className="relative z-10 text-foreground/80 leading-relaxed">
            Supported hydropower operations across the western U.S., focusing on
            governor and excitation compliance, embedded control software, and
            field instrumentation for plant testing.
          </p>
        </div>
      </section>
