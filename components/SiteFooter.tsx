...
export default function SiteFooter() {
  return (
    <footer className="relative z-10 mt-16 border-t border-[var(--glass-border)]">
        ...
        <SocialIcon
          ...
          svg={
            <svg viewBox="0 0 24 24" aria-hidden className="size-5">
              <path
                fill="currentColor"
                d="M4.98 3.5C4.98 4.88 3.86 6 2.5 6S0 4.88 0 3.5 1.12 1 2.5 1 4.98 2.12 4.98 3.5zM.5 8.1h4V24h-4V8.1zM8.9 8.1h3.8v2.16h.05c.53-1 1.83-2.16 3.77-2.16 4.03 0 4.77 2.65 4.77 6.1V24h-4v-7.62c0-1.82-.03-4.16-2.53-4.16-2.53 0-2.91 1.98-2.91 4.03V24h-4V8.1z"
              />
            </svg>
          }
        />
...
function SocialIcon({
  ...
  return (
    <Link
      href={href}
      aria-label={label}
      className="group relative inline-flex items-center gap-2 rounded-xl border border-[var(--glass-border)] bg-[var(--glass-bg)] px-4 py-2 overflow-hidden backdrop-blur-md transition-all duration-300 hover:bg-[var(--glass-bg-strong)]"
