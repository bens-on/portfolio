  ...
  return (
    <header className="w-full fixed top-0 left-0 right-0 z-50 bg-background/50 backdrop-blur-sm">
      <div className="w-full h-12 sm:h-14 flex items-center justify-between gap-3 px-4 sm:px-8 md:px-16 lg:px-[125px]">
        <Link 
          href="/launches" 
          className="inline-block shrink min-w-0 rounded-xl focus:outline-none focus:ring-2 focus:ring-red-500/40 focus:ring-offset-2 focus:ring-offset-background"
          aria-label="Recent Launches"
        >
          <div
            className="group relative inline-flex items-center gap-1.5 sm:gap-2 rounded-xl border border-red-400/40 bg-red-500/15 px-2.5 py-1.5 sm:px-4 sm:py-2 overflow-hidden backdrop-blur-sm transition-all duration-300 hover:bg-red-500/20"
            style={{
              boxShadow:
          ...
          >
            ...
            >
              ...
              <span className="hidden sm:inline">Recent Launches 🚀</span>
            </span>
          </div>
        </Link>
        <GlassNav />
