...
function NavLink({ item, onClick }: { item: NavItem; onClick?: () => void }) {
  const linkContent = (
    <div className="group relative inline-flex items-center gap-2 rounded-xl border border-[var(--glass-border)] bg-[var(--glass-bg)] px-4 py-2 overflow-hidden backdrop-blur-md transition-all duration-300 hover:bg-[var(--glass-bg-strong)] hover:shadow-glow-primary/30">
